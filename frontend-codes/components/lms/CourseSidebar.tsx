    ...
    <div className="h-full bg-[#2d2f31] border-l border-[#3e4143] flex flex-col w-[400px]">
      ...
      <div className="flex items-center justify-between p-4 border-b border-[#3e4143] bg-[#2d2f31] flex-shrink-0">
        ...
        <Button
          ...
          size="sm"
          onClick={onToggleCollapse}
          className="text-gray-400 hover:text-white hover:bg-[#3e4143] p-2 transition-colors lg:block hidden"
          title="Hide sidebar"
        >
        ...
        <Button
          ...
          size="sm"
          onClick={onToggleCollapse}
          className="text-gray-400 hover:text-white hover:bg-[#3e4143] p-2 transition-colors lg:hidden"
          title="Close sidebar"
        >
          <ChevronRight className="w-5 h-5" />
        </Button>
