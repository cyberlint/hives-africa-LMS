    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <header className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 md:gap-8 mb-6">
        <div className="flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6 py-6 border-y border-border my-6">
            {/* Date Section */}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-medium text-foreground leading-tight italic opacity-80">
                  {event.eventCategory}
                </p>
              </div>
            </div>
        ...
        {event.imageKey && (
          <div className="w-full md:w-80 h-48 md:h-64 relative rounded-lg overflow-hidden shadow-sm border border-border">
            <Image
      ...
      {/* Description Section */}
      <section className="prose prose-slate dark:prose-invert max-w-none mt-8 mb-12">
        <h3 className="text-2xl font-semibold mb-4 text-foreground">About this event</h3>
      ...
      {/* Host Section */}
      <section className="flex items-center gap-5 mb-10 p-4 rounded-xl bg-muted/50 border border-border/50">
        <div className="w-14 h-14 rounded-full bg-background border border-border flex items-center justify-center text-muted-foreground text-xl font-bold shadow-sm">
          {event.user.name.charAt(0)}
        </div>
        <div className="flex-1">
          <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Host</p>
          <h3 className="text-lg font-bold text-foreground">{event.user.name}</h3>
      ...
      {/* Footer Actions */}
      <footer className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-6 pt-6 border-t border-border">
