        ...
        <Card className="w-full max-w-md lg:max-w-3xl border-green-200 shadow-xl">
          ...
          <CardContent className="space-y-6">
            <div className="text-center space-y-4">
              <p className="text-[#6E7485] leading-relaxed">
              ...
              {paymentDetails?.course_title && (
                <div className="bg-white border border-green-200 rounded-xl p-4 shadow-sm flex flex-col md:flex-row gap-4 items-center md:items-start text-left">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <h3 className="font-bold text-darkBlue-300 text-lg line-clamp-2">
                      {paymentDetails.course_title}
                    </h3>
                    
                    {paymentDetails.instructor && (
                      <p className="text-sm text-[#6E7485]">
                        Instructor: <span className="font-medium text-darkBlue-300">{paymentDetails.instructor}</span>
                      </p>
                    )}
          ...
          <div className="text-center space-y-4">
            ...
            <div className="space-y-3 pt-2">
              ...
              <Button
                ...
                variant="ghost"
                className="w-full text-sm text-[#6E7485] hover:text-darkBlue-300"
              >
                Contact Support
              </Button>
            </div>
