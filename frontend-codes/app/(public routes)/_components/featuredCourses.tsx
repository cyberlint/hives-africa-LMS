    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {courses.slice(0, 4).map((course) => (
            <div
              key={course.id}
              className="flex border border-[#E9EAF0] shadow-[0px_11.12px_29.65px_0px_#1D20261A] h-full w-full cursor-pointer hover:shadow-xl transition-shadow"
            >
              <div className="h-full w-[30%]">
                <Image
                  src={course.thumbnail || "/assets/courses/course-img4.png"}
                  alt={course.title}
                  width={250}
                  height={300}
              ...
              <div className="bg-white w-[70%]">
                <div className="space-y-2 px-5 py-3">
                  <div className="flex flex-wrap justify-between items-center gap-x-2 gap-y-1">
                    <p
                      className="uppercase text-[8px] font-semibold p-1 bg-[#E1F7E3] text-[#15711F]"
                    >
                  ...
                  <div className="flex flex-wrap justify-between items-center gap-y-1 pt-2">
                    <div className="flex justify-center items-center gap-2">
                      <div className="h-4 sm:h-6 w-4 sm:w-6 rounded-full bg-gray-200 flex items-center justify-center">
