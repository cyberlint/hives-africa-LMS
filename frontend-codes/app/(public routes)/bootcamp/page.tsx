    ...
    <main className="-mb-16 bg-background">
      ...
      >
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
          <div className="space-y-6 md:space-y-8">
            <h2 className="text-3xl font-black leading-[1.1] tracking-tight text-foreground md:text-5xl">
              Your Portfolio,
              <br />
              Already Working.
            </h2>
            ...
            <div className="space-y-4 text-base leading-relaxed text-muted-foreground">
              ...
              <p className="border-t border-border/50 pt-4 text-xs font-black uppercase tracking-widest text-foreground">
      ...
      >
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {[
              { w: "Week 1", t: "Foundation", d: "Analytics lifecycle. Structured thinking. Excel-based modeling." },
              { w: "Week 2", t: "Data Handling", d: "EDA, cleaning, transformation using Power Query." },
              { w: "Week 3", t: "Intelligence Layer", d: "Data modeling + DAX. Build decision-grade dashboards." },
              { w: "Week 4", t: "Capstone Deployment", d: "End-to-end execution. Reviewed. Approved. Published to your portfolio." },
            ].map((wk, i) => (
              <div
                key={i}
                className="group rounded-[2rem] border border-border/50 bg-card p-6 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-orange/30 hover:shadow-xl sm:p-8"
              >
                <div className="mb-4 text-sm font-black uppercase tracking-widest text-muted-foreground transition-colors group-hover:text-orange">
                  {wk.w}
                </div>
                <h3 className="mb-2 text-xl font-bold text-foreground">{wk.t}</h3>
                <p className="text-sm leading-relaxed text-muted-foreground">{wk.d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <h2 className="mb-12 text-center text-3xl font-black tracking-tight text-foreground md:text-4xl">
            Critical Details
          </h2>

          <div className="space-y-4">
            {[
              { q: "Do I need prior experience?", a: "No. The system is structured to take you from foundation to execution. What matters is consistency.", sys: "Activity Engine" },
              { q: "What makes this different from other bootcamps?", a: "Your work is verified, reviewed, permanently recorded, and publicly visible. Not stored locally or forgotten.", sys: "Submission & Review Framework" },
              { q: 'What exactly is "Reputation"?', a: "It is your operational currency inside NextHive. You earn it by contributing. You use it to start Hives, open bounties, and signal credibility.", sys: "Reputation Ledger" },
              { q: "Will I actually have a portfolio at the end?", a: "Yes. Automatically generated from your approved work. No extra effort required.", sys: "Portfolio Automation" },
            ].map((faq, i) => (
              <div
                key={i}
                className="overflow-hidden rounded-2xl border border-border/50 bg-card shadow-sm transition-all hover:border-foreground/30"
              >
                <button
                  onClick={() => setActiveFaq(activeFaq === i ? null : i)}
                  className="flex w-full items-center justify-between px-6 py-5 text-left font-bold text-foreground"
                >
                ...
                <div
                  className={cn(
                    ...
                    activeFaq === i ? "max-h-[250px] opacity-100" : "max-h-0 opacity-0"
                  )}
                >
                  <div className="space-y-4 border-t border-border/20 px-6 pb-5 pt-4 text-sm leading-relaxed text-muted-foreground">
                    <p>{faq.a}</p>
                    <div className="flex w-fit items-center gap-2 rounded-lg bg-orange/10 px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest text-orange">
      ...
      >
        <div className="pointer-events-none absolute left-1/2 top-1/2 -z-10 size-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange/10 blur-[120px]" />
        ...
        <div className="relative z-10 mx-auto max-w-2xl space-y-8 px-4">
          ...
          <div className="flex flex-col items-center gap-2 text-base font-medium text-muted-foreground md:text-lg">
            <p>Create your account. Verify your identity.</p>
            <p>Claim your 50 Rep. Start forming your Hive.</p>
          </div>

          <div className="pt-6">
            <Link
              href="/register"
              className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-orange px-10 py-5 text-sm font-bold text-white shadow-lg shadow-orange/20 transition-all hover:scale-[1.02] hover:shadow-orange/40 sm:w-auto sm:text-base"
            >
