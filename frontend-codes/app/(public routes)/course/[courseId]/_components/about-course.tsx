        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0F1D2F] mb-4 sm:mb-6">About Course</h2>

              <div className="max-w-4xl">
                <p className="text-[#0F1D2F] text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
                  {course.description}
                </p>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6 shadow-sm lg:sticky lg:top-32">
                {/* Price Section */}
                <div className="mb-4 sm:mb-6">
