...
export default function EntryRequirements({ course }: EntryRequirementsProps) {
  return (
    <section id="requirements" className="py-8 sm:py-12">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#0F1D2F] mb-6 sm:mb-8">Entry Requirements</h2>

            {/* Academic Requirement */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-xl font-semibold text-[#0F1D2F] mb-4">Academic Requirement</h3>
              <p className="text-[#6B7280] text-sm sm:text-base mb-4 sm:mb-6">
                This course is designed for {course.level.toLowerCase()} learners. No specific academic requirements needed.
              </p>

              {/* English Requirement */}
              <h4 className="text-base sm:text-lg font-medium text-[#0F1D2F] mb-4">Language Requirement</h4>
              <div className="bg-white border border-[#E2E8F0] rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 items-center">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-xl sm:text-2xl font-bold text-[#0F1D2F]">6</div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xl sm:text-2xl font-bold text-[#0F1D2F]">75</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Other Requirements */}
            <div>
              <h3 className="text-lg sm:text-xl font-semibold text-[#0F1D2F] mb-4">Course Prerequisites</h3>
              <div className="mb-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-[#0F1D2F] text-sm sm:text-base">Basic computer literacy and internet access</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-yellow rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-[#0F1D2F] text-sm sm:text-base">Enthusiasm to learn and practice new skills</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-yellow rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-[#0F1D2F] text-sm sm:text-base">
