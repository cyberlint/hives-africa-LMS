                    ...
                    <div key={section.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                      ...
                      >
                        <div className="flex-1 pr-4">
                          <span className="font-medium text-[#0F1D2F] text-sm sm:text-base block">
                            {section.title}
                          </span>
                            ...
                            {section.lectures.map((lecture, index) => (
                              ...
                              >
                                <div className="flex items-center space-x-3 flex-1">
                                  <span className="text-[#6B7280]">{getLessonIcon(lecture.type)}</span>
                                  <div className="flex-1">
                                    <p className="text-sm text-[#0F1D2F]">{lecture.title}</p>
                                    {lecture.description && (
