...
export default function TabsNavigation({ activeTab, onTabChange }: TabsNavigationProps) {
  return (
    // sticky top-20
    <div className=" bg-white dark:bg-[#2a2f3a] border-b border-gray-200 dark:border-[#404854] transition-colors duration-300 z-40 w-full">
              ...
              <button
                ...
                className={`py-3 sm:py-4 px-2 whitespace-nowrap border-b-2 font-medium text-xs sm:text-sm transition-colors flex-shrink-0 ${
                  activeTab === tab.id
                    ...
                    : "border-transparent text-[#6B7280] dark:text-gray-400 hover:text-[#0F1D2F] dark:hover:text-gray-200"
                }`}
              >
                {tab.label}
              </button>
