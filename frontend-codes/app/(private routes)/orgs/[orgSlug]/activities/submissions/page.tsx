...
export default async function SubmissionsDashboard({
  ...
  activity: {
    organizationId: organization?.id, // Filter activities by the organization ID
    ...
    ...(resolvedSearchParams.programId
      ? { programId: resolvedSearchParams.programId }
      : {}),
    ...
    return (
        <div className="w-full max-w-6xl mx-auto p-4 sm:p-6 space-y-8">
            ...
            <div className="flex flex-col gap-1">
                ...
                <p className="text-sm text-muted-foreground">Manage and review individual and hive submissions.</p>
            </div>
