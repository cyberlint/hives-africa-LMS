import { Block, CalloutVariant }   from "./types";
...
export const blocks = {
  ...
  callout: (label: string, content: string, variant: CalloutVariant = "default"): Block => ({ type: "callout", label, content, variant, }),
  cta: (label: string, url: string): Block => ({ type: "cta", label, url, }),
